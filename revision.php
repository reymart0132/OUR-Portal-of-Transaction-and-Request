...
if(isset($_POST['tn'])){
     $pt= new revisetransaction($transaction[0]->fullname,$_GET['tn'],$uid,$_POST['reason']);
     $pt->reviseTransaction();
     $pt->reviseStatus();
          ...
          <form action="" method="POST">
            <div class="row justify-content-center my-4">
              ...
              <div class="form-group col-md-12">
                <label for="Course" >Revision Reason</label>
                <input type="text" class="form-control" id="reason" oninput="this.value = this.value.toUpperCase()"  name="reason" aria-describedby="emailHelp" placeholder="Enter revision reason"  required>
                <small class="text-muted"><b>*Please indicate the removal reason.</b></small>
              </div>
              <div class="form-group col-md-12">
                <input type="submit" value="For Revision" class=" form-control btn btn-warning" />
              </div>
            </div>
          </form>
        </div>
