  ...
  <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm slide-in-left" style="z-index:10; ">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        ...
        <div class="container mt-5 puff-in-center shadow-sm p-4">
          <div class="row">
            ...
            <div class="col-md-8 text-center">
              <h4>Resource Output Tracker</h4>
              <form action="" method="POST">
                <?php
                  if(empty($_POST['dn'])){
                    echo '<input type="date" name="dn" id="datePicker"/>';
                  }else{
                    echo '<input type="date" name="dn" value="'.$_POST['dn'].'" />';
                  }
                ?>
          ...
          <div class="row">
            <?php
              ...
              $viewdata = new viewdata($uid,$today);
              $viewdata->viewPrintedCount();
              $viewdata->viewPullout();
              $viewdata->viewPrinted();
              $viewdata->viewSigned();
              $viewdata->viewRevised();
              $viewdata->viewReleased();
              $viewdata->viewVerified();
