      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuVerification">
            ...
            <a class="dropdown-item active" href="verificationpool.php">Verification Pool</a>
        ...
        <div class="container-fluid mt-5 puff-in-center">
          <h4 class="text-center">List of Unassigned Pending Verification</h3>
          <div class="row justify-content-center">
            <?php $viewtables->viewPool2Table(); ?>
          </div>
        </div>
</body>
