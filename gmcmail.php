...
if(isset($_POST['tn'])){
  echo "here";
     $atm= new assigntome($_POST['team'],$_POST['tn']);
     $atm->assigntome();
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        ...
        <div class="container mt-5 puff-in-center">
          <form action="gmcmakemail.php" method="GET">
            <div class="row justify-content-center my-4">
              ...
              <div class="row justify-content-left">
                <input type= "hidden" name="fullname" value="<?php echo $transaction[0]->fullname;?>" />
                <input type= "hidden" name="dateapp" value="<?php echo $transaction[0]->dateapp;?>" />
                <input type= "hidden" name="course" value="<?php echo $transaction[0]->course;?>" />
                <input type= "hidden" name="email" value="<?php echo $transaction[0]->email;?>" />
                <input type= "hidden" name="student_number" value="<?php echo $transaction[0]->student_number;?>" />
              ...
              <div class="form-group col-md-12">
                <label for="Course" >Send Email to College Secretary</label>
                    <select id="a" name="team" onchange="change();" class="selectpicker form-control" data-live-search="true" required>
                      <?php
                       $view->findSecretary();
                       ?>
                    </select>
              ...
              <div class="form-group col-md-12">
                <input type="submit" value="Create a GMC Request to School/College" class=" form-control btn btn-primary" onclick="pload()" />
              </div>
            </div>
          </form>
        </div>
