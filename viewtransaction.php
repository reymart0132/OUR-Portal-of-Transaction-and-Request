      ...
      <ul class="navbar-nav ml-auto">
        ...
        <div class="container mt-5 puff-in-center">
          ...
          <div class="row justify-content-left">
            ...
            <div class="col-md-4 mb-3">
              <h6>Remarks: <b style="color:#ff8ba0;"><?php echo $transaction[0]->status;?></b></h6>
            </div>
            ...
            <div class="col-md-12 mb-3">
              <h6>Remarks: <b style="color:#ff8ba0;"><?php echo findPurpose($transaction[0]->purpose);?></b></h6>
            </div>
            <a href="assigntome.php?tn=<?php echo $_GET['tn'];?>"class='btn btn-success btn-sm mr-3'><i class='fa fa-user-check'></i> Assign to Me</a>
            <a href='assigntoteam.php?tn=<?php echo $_GET['tn'];?>' class='btn btn-warning btn-sm mr-3'><i class='fa fa-user-friends'></i> Assign to Team</a>
            <a href='removetransaction.php?tn=<?php echo $_GET['tn'];?>' class='btn btn-danger btn-sm mr-3'><i class='fa fa-trash'></i> Delete Transaction</a>
          </div>
        </div>
</body>
