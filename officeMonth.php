...
$user = new user();
$uid = $user->data()->id;
$viewtables = new viewtables($uid,$_GET['dn']);
$vd= new viewdata();
if(empty($_GET) || $_GET['dn'] == ""){
    Redirect::to('office.php');
}
 ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm slide-in-left" style="z-index:10; ">
    ...
    <div class="container-fluid mt-4 puff-in-center">
      <div class="row">
        <div class="col-md-5">
          <h1>Monthly Office Transaction Report</h1>
          <h5 class="my-3"><i class='fa fa-clock'></i> Average Office Transaction Cycle Time for this Month: <a href="#"><?php echo findCycleTime3($_GET['dn']);?> Days </a></h5>
          <h5 class="mb-3"><i class='fa fa-file-alt'></i> Total Office Pending Transaction: <a href="#"><?php echo findPending3($_GET['dn'])?> transaction/s</a></h5>
          <h5 class="mb-3"><i class='fa fa-share'></i> Total Transaction Received for this Month: <a href="#"><?php echo findReceivedTransaction2($_GET['dn'])?> transaction/s</a></h5>
          <h5 class="mb-3"><i class='fa fa-check-circle'></i> Total Transaction Completed and Ready for Release this Month: <a href="#"><?php echo findCompletedTransaction2($_GET['dn'])?> </a></h5>
          <h5 class="mb-3"><i class='fa fa-shoe-prints'></i> Total Transaction Released this Month: <a href="#"><?php echo findReleasedTransaction2($_GET['dn'])?> </a></h5>
        </div>
        <div class="col-md-4">
          <h3 class="mt-3 ">Breakdown of Printed Documents</h3>
          <?php $vd->viewPrintedCountOffice2($_GET['dn']); ?>
        </div>
        <div class="col-md-3">
          <h3 class="mt-3 ">View Other Monthly Report</h3>
          <form action="" method="GET">
            <input type="month" name="dn" id="datePicker" value="<?php echo $_GET['dn'] ?>"/>
    ...
    <div class="container-fluid mt-5 puff-in-center">
      <?php $viewtables->viewTransactionTable2(); ?>
    </div>
</body>
