      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuTransaction">
            <a class="dropdown-item active" href="transactionpool.php">Transaction Pool</a>
        ...
        <div class="container-fluid mt-5 puff-in-center">
          <div class="row justify-content-center">
            <h4 >List of Unassigned Pending Transaction (Office of the Registrar)</h3>
          </div>
          <div class="row justify-content-center">
            <?php $viewtables->viewPoolTable(); ?>
          </div>
        </div>
</body>
