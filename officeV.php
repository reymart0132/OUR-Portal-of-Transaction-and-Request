...
<body>
  <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm slide-in-left" style="z-index:10; ">
    ...
    <div class="container-fluid mt-4 puff-in-center">
      <div class="row">
        <div class="col-md-5">
          <h1>Overall Office Verification Report</h1>
          <h5 class="my-3"><i class='fa fa-clock'></i> Average Office Verification Cycle Time for this Month: <a href="#"><?php echo findCycleTime2();?> Days </a></h5>
          <h5 class="mb-3"><i class='fa fa-user-check'></i> Total Office Pending Verification: <a href="#"><?php echo findPending2()?> verification/s</a></h5>
          <h5 class="mb-3"><i class='fa fa-users'></i> Total Verification Received for this Month: <a href="#"><?php echo findReceivedVerification()?> transaction/s</a></h5>
          <h5 class="mb-3"><i class='fa fa-check-circle'></i> Total Verification Completed: <a href="#"><?php echo findCompletedVerification()?> </a></h5>
        </div>
        <div class="col-md-4">
          <h3 class="mt-3 ">Breakdown of Verification Remarks</h3>
          <?php $vd->viewVerificationCountOffice(); ?>
        </div>
        <div class="col-md-3">
          <h3 class="mt-3 ">View Other Monthly Report</h3>
          <form action="officeVMonth.php" method="GET">
            <input type="month" name="dn" id="datePicker" value=""/>
        ...
        <div class="container-fluid mt-5 puff-in-center">
          <?php $viewtables->viewVerificationTbl(); ?>
        </div>
</body>
