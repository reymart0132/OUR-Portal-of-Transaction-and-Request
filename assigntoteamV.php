...
if(isset($_POST['team'])){
  echo "here";
     $atm= new assigntomeV($_POST['team'],$_POST['tn']);
     $atm->assigntomeV();
        ...
        <div class="container mt-5 puff-in-center">
          <form action="" method="POST">
              <div class="form-group col-md-12">
                ...
                <label for="Course" >Assign Candidate Verification to Team Member</label>
              ...
              <div class="form-group col-md-12">
                <input type="submit" value="Assign Transaction to SRA" class=" form-control btn btn-primary" />
              </div>
            </div>
          </form>
        </div>
