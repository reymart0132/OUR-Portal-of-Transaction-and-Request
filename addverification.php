...
<a class="dropdown-item " href="sfiles.php">Special Files </a><a class="dropdown-item " href="frelease.php">For Releasing </a>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuVerification">
            <a class="dropdown-item active" href="addverification.php">Add Verification</a>
    ...
    <div class="container mt-4 puff-in-center mb-5">
      <div class="row">
          <div class="col-12">
              <h1 class="text-center">New Alumni Candidate Verification</h1>
          </div>
          <?php if (!empty($_GET)) {
              SuccessV($_GET['status']);
          }?>
      </div>
      <form action="/report/resource/php/registerVerification.php" method="POST">
      <div class="row mb-5">
          <table class="table">
                  <tr>
                      <td>
                          <div class="row">
                            <div class="form-group col-12">
                              ...
                              <div class="form-group col-lg-4">
                                ...
                                <input type="text"  class="form-control" id="edate" name="edate" aria-describedby="emailHelp" placeholder="Enter  Year Graduated or Last Enrolled">
                              </div>
                              <div class="form-group col-lg-4">
                                <label for="gdate">Graduation Date / Last Enrolled Date </label>
                                <input type="text"  class="form-control" id="gdate" name="gdate" aria-describedby="emailHelp" placeholder="Enter  Year Graduated or Last Enrolled">
                              </div>
                              <div class="form-group col-lg-4">
                                <label for="gdate">Birthdate</label>
                                <input type="date"  class="form-control" id="bdate" name="bdate" aria-describedby="emailHelp" placeholder="Enter  Year Graduated or Last Enrolled" required>
                              </div>
                          </div>
                      </td>
                  </tr>
                      ...
                      <td>
                          <div class="row">
                              <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="Lastname"  name="Course" placeholder="Enter Course" required>
                              </div>
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <div class="form-control">
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="type" id="International" value="International" checked>
                                        <label class="form-check-label" for="International">International</label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="type" id="Local" value="Local">
                          ...
                          <div class="row">
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" id="Lastname"  name="vcompany" placeholder="Enter Verifying Company">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="Course" >Document Attachments</label>
                              <input type="text" class="form-control" id="Lastname"  name="doca" placeholder="Document Attachments">
                            </div>
                          </div>
                      </td>
                  </tr>
