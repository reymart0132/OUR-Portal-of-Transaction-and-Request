...
if(isset($_POST['tn'])){
     $dt= new deletetransaction($_POST['reason'],$_POST['tn'],$uid);
          ...
          <form action="" method="POST">
            <div class="row justify-content-center my-4">
              ...
              <div class="form-group col-md-12">
                <label for="Course" >Removal Reason</label>
              ...
              <div class="form-group col-md-12">
                <input type="submit" value="Remove Transaction" class=" form-control btn btn-primary" />
              </div>
            </div>
          </form>
        </div>
